...
from ..utils.image import read_image_glayscale, read_image_rgb
...
class PascalVocGenerator(Generator):
    ...
    def load_image(self, image_index, mode='grayscale'):
        """ Load an image at the image_index.
        """
        if mode == 'grayscale':
            return read_image_glayscale(self.image_path(image_index))
        elif mode == 'rgb':
